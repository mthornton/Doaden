...
|------|-----------|---------------------|
| JonLief.md | **JonLief** | **Elf** (confirmed by NPCs). Bow/sword/light armor, bear-fur cloak that "fits perfectly." Meditates instead of sleeping. The party's de-escalator and diplomat. Exiled noble; secret marriage; wife **Elizabeth** and son **Rowan** banished and (he now learns) sold, not killed. |
...
- ⚠️ **THE BOOK HAS BEEN READ** — `What the Party Knows - The Book.md`. **Stop writing that nobody has opened it.** JonLief read *Myths of the Old Gods* on the road before Bramblefen (late Sept 1126) and briefed the party, so all of it is **player knowledge**: old gods run on mana and were starved by the Ascension; **Adephagia** needs no worship (she eats vice itself) and her cults are gourmand clubs and merchant syndicates, not temples; **Saraswati** is the naive six-armed patron of art, refuelled by **Vasant Panchami** on the fifth day of spring — **a ~5-month clock from early Oct**; **Brudda Death** is not an old god but the Prison Realm's jailer with iron bars where his stomach was, and **summoning his Aspect needs BOTH massive mana AND the "Catalyst of Suffering" — large-scale, concentrated human suffering.** ⚠️ That second requirement describes a slave compound with a fighting pit, so the party may well suspect Bramblefen; being wrong about that is more interesting than being right. Also now known: the **Black Scrolls** are divine ledgers, the key that makes Brudda Death open his cage, purged by the God Emperor because a perfect record was intolerable, and a **Primal Copy** carrying his secret history is rumoured to be inside **Jormungand**. The book is a **Church** volume by Abbot Valerius Thorne that contradicts Church doctrine — carrying it is not neutral. **Corbin's Ch9 scene is superseded**: he fills gaps and reacts, he does not read it for them.
...
- **The barrels** — `The Blood of Saraswati.md`: **the most important unaccounted-for thing in the campaign.** Adephagia's cult bleeds **Saraswati** (chained alive under Dol, side opened) into casks; a god's blood is the energy source for giving **Brudda Death** physical form. The party has seen it twice — barrels going aboard a ship on Dol (Ch2) and the blood-filled stone circle plus a couple of barrels in the St. Pyotr's chapel (Ch4) — and has **correctly** worked out it is Saraswati's, ships by sea, and fuels a Brudda Death ritual. ⚠️ **What they have NOT realised is that there were never only a couple of barrels.** The cult moves it as ordinary contraband because being boring is the disguise; **Lord Ironwake taxes all illicit transport in and out of Solteres, so the barrels are in his tax records** (weight, date, destination, buyer name). Ironwake does not know what's in them — he knows casks come in heavier than the manifest, that he is paid a premium not to open them, and that a dockhand who opened one had a bad end. **Fear-shaped hole where knowledge would be: he can hand over the records without betraying anyone.** 🎯 **ACTION: plant one ordinary barrel in Vaskar's stores in Ch7 Session 2** — unhidden, unguarded, iron-hooped, pitch-sealed, heavier than its neighbours, tariff-mark burnt into the head. Don't point at it; if they walk past it, let them. **Open thread — the Penitents' blood:** ordinary blood has no power, a Penitent's does (the brand is consecrated). Three unresolved reasons the cult bled the first team into the same casks: (1) a **tracer** so the cult can find its own barrels by the Shepherds' mechanism — best, turns the party's brands into an asset; (2) the cult **studied the brand** and learned to track Penitents; (3) **nothing** — they had the barrels and knives out and simply chose that method. **Keep all three live to Ch9–10.** Gimble is the only living witness.
- **The second ledger** — `The Second Ledger.md`: what is actually written in Old Cobb's hidden book, at four escalating levels of scrutiny. **It is a procurement record**: thirty-eight years of an unnamed buyer ("Ashgate") purchasing people from Bramblefen — predominantly women, disproportionately artists — paid by drafts guaranteed by respectable Solteres houses, with a sharp surge beginning two years ago. Cobb thinks it's evidence of slavery; it is evidence of **heresy**, which is the only thing the Church will act on. **Using it converts seized "heretic" property — including slaves — into Penitents.** Also carries the campaign's spine: Stock, Terms and Penitents are three doors with one justification, and all three get run in the same register.
- **The hunters** — `The Office of the Lost Flock.md`: the Church arm that goes after Penitents who stop reporting. Vozruk called the party "lambs for the flock" in Ch1; the men sent after strays are **Shepherds**, known on the road by the violet cloak alone. The Office strikes a small silver lamb for every Penitent a Shepherd LOST (never for one saved), stamped with what took them — **but they are issued, not worn.** Almost every Shepherd keeps his in a box. **Only two men in the Office wear them: Baltus Thole and Ivo Kessler**, and the other Shepherds consider Baltus's coat zeal, a private weight made public — and nobody has ever pointed out to him who the other man is. **The Mark of Atonement is a leash** (long-planned, hinted at the table, NOT new): consecrated at the forge; an assigned Shepherd gets a compass bearing at dawn prayer, within a diocese. **⚠️ The dead pull exactly as strong as the living until the body rots** (~a month in the open; years in bog, salt, cold, or a dry crypt; never, if deliberately preserved) — **so a Shepherd never knows whether his quarry is alive until he is standing over them.** **⚠️ The brand fades in proportion to the debt remaining** — this party owes 500 years and has served 2.5 months, so their pull is about as loud as a pull gets, which is why Baltus was glad; someone near the end of a short term is nearly untraceable; at discharge it goes inert, and that is the door. **⚠️ Cutting the brand out does NOT work** — nor burning it, flaying it, or taking the whole limb; the bond is in the person, not the skin. **The ONLY clean severance is a ceremony taught to Shepherds alone**, which is why Hedda can do what she does and why the party cannot free themselves. Shielded ground (Dol's catacombs, St. Pyotr's fog) hides the pull without breaking it. Silence at prayer could mean rotted, out of diocese, shielded, discharged, or severed — five answers, one identical nothing. Explains the Church's reach, why Vaskar is terrified of holding a branded Penitent, and why the Church doesn't know most of its missing are dead. Five hunters planned; **all 5 built.**
- **Baltus Thole** — `Baltus Thole.md`: the first Shepherd. Large, devout, unhurried, two-handed maul, **thirty-one lambs, fourteen stamped *unknown* — and nothing at all for the nine he brought home, because that was only the job.** CR 6. **Never deals lethal damage to a Penitent** — he breaks legs because he needs them alive. He is coming for THIS party: he prayed over their file two weeks ago and felt four pulls, and it is the gladdest he has been in years. Not a fight; a decision.
- **Hedda Merrow** — `Hedda Merrow.md`: the second Shepherd. Forty-one, black hair worn long, violet cloak bare like almost every Shepherd's — her **forty-seven lambs ride in a pouch, and eleven of them in a separate pocket.** Known across the Office as its killer — and **eleven of the forty-seven are alive.** The Office accepts only the brand itself as proof of death, so the only difference between a Penitent she killed and one she freed is whether she cut the mark off a corpse or off someone breathing; **the proof is always genuine, the lie is entirely in the verb.** Crucially she uses the **Shepherd's ceremony** — the only real severance — which is why no one but a Shepherd could do this. It is not mercy: it frees them but kills any chance of ever lawfully discharging the debt, and leaves them dead on paper with no way back. She frees people the system broke, never runners. **Tell: hair down = still deciding, hair tied back = decided.** CR 5, twin daggers, Assassinate. Baltus trained her and must never find out.
- **Provost Emeric Sault** — `Emeric Sault.md`: the third Shepherd, and the one who runs the other two. Sixty-eight, brown hat, brown satchel, and a **violet cloak with no lambs on it at all** — not because he never lost one, but because he has never been *assigned* one. The satchel holds **open files nobody has been assigned**; since the bond is inert until assignment, **he personally decides who gets hunted**, and the party walked free for eleven weeks because he chose not to open their file. He gave it to Baltus two weeks ago. **⚠️ The barbed mace is liturgical — the Rite of Reaffirmation is the inverse of the Shepherd's ceremony, putting the Mark of Atonement BACK on a living, held subject whose bond was severed, reopening the file and striking out the years.** He is the only living man ordained for it. Nine times in forty years. **This is the knife at Hedda's eleven** — she frees people with the ceremony, which is exactly the severance Sault can undo. He has done the arithmetic on Hedda and buried it because her reputation is useful. Baltus does not know he is being managed. CR 4 — killing him is easy and catastrophic.
- **Ivo and Wendel Kessler** — `Ivo and Wendel Kessler.md`: Shepherds four and five, brothers, **the pair the Office does not write down.** Enormous violet hats. Sault releases them verbally — a place and a direction, no file, no signature — when a Penitent unit has gone too deep with an evil of epic scale, because the Church would rather not be documented as having known. **Ivo** (elder, very tall, gaunt, broadsword nearly his own height, tattered robe, **one of only two Shepherds who wears his lambs — the other is Baltus**): broken by accumulation, no single cause — *deliberately left unspecified.* His coat carried 58 lambs and has **19 holes**; Wendel keeps sewing them back and they keep going, and nobody has ever seen him take them off. **His madness is contagious pressure, not magic** — he says true, specific, unbearable things about you in a flat voice; DC 14 WIS or take a splinter. CR 8. **Wendel** (younger, keeper): bare cloak; his own twelve lambs stay in the tin he uses to re-sew his brother's. Stays in the Office only because leaving means Ivo goes out alone. Two hand crossbows — **left is steel for the target, right is 'grace' (blunt + soporific) for Penitents, bystanders, and Ivo, whom he has shot eleven times.** CR 5. **Their arrival is a verdict, not a hunt** — save them for Saraswati/Adephagia/under-Dol, not Bramblefen.
...
| Chapter 7 - Session 1 - Game Play Notes.md | **PLAYED 8/16/2026** | Play log for the first night of Chapter 7: the campfire, Ysabel's backstory and her refusal, Erwana at dawn, the ledger paying off (Elizabeth and Rowan), the deal for Ysabel's cover, and arrival at Bramblefen at 5:30 pm with the party inside the gate. **Session 1 covered the Run Sheet's Night 1.** |
| Chapter 7 DM Notes - Session 2 Onward.md | **NOT YET PLAYED — prep** | **The current working prep for the rest of Chapter 7.** Supersedes `Chapter 7 DM Notes.md` wherever they disagree. Written after Session 1: the party is inside via the buyers' cover, Erwana is gone to Ald's Star, the Drain is dead, sundown is fixed at 8:00 (stated at the table), giving 2.5 hours from arrival, and Vaskar is expecting them with Cobb tied up in the same building. **Read this first when prepping the next session.** |
| Chapter 7 - Session 1 - The Story.md | **Player-facing prose** | Session 1 written as a story in the Chronicle's voice, to hand to the players. |
| Chapter 7 DM Notes.md | **IN PROGRESS — Session 1 played 8/16/2026** | The Chained Coast: raid on the slaver holdfast **Bramblefen**. Living working file; the older `Chapter 7 The Chained Coast.md` was deleted and replaced by it. **Erwana is caught at dawn, not at the evening fire** (an evening meeting sends the party marching overnight and wrecks the sundown clock). **Ysabel's five household servants travel with the party for the whole chapter — and one of them, Dov Brandt, is her property. **Ysabel herself owns non-human slaves** who work her mills and warehouses, and holds sincere, unembarrassed views about non-humans being beneath humans — play her reasonable, never cruel; see `Solteres.md`**: a Terms man she bought at Bramblefen two years ago, with three years left. He is the chapter's living explanation of Stock vs. Terms. **Garrison revised Aug 2026: 20 men (14 Fen Guard + 6 Ironwake), not 13** — beefed up around the Juggernaut and the sundown match. **Erwana and Ysabel will both honestly tell the party four or five**, because that is the normal complement and both are a month out of date; see item 9a. Correct it from the treeline before they commit, and let Anselm supply the real number. |
...
2. **The slaver plot (active — this is Chapter 7).** JonLief's wife **Elizabeth** and son **Rowan** were sold, not killed. **Confirmed in Session 1:** Cobb's second ledger records them arriving at Bramblefen about two months ago; the book stops six weeks ago, so it does *not* name the boy's buyer. The trail runs Bramblefen → **the working ledger in Vaskar's office** → a chimney sweep named **Barney Soot** in Solteres → **Lord Ironwake**, who is also rigging Lady Ysabel's trial by combat using the Juggernaut as his champion. Ysabel's trial lands in Chapter 8.
...
| **Elizabeth** (JonLief's wife), **Rowan** (his son) | — |

### Known continuity conflicts (flag before using, don't silently pick one)
- **Elizabeth, not Maren — RETCON (Session 1, 8/16/2026).** Neither the DM nor the player could recall JonLief's wife's name at the table, so the player named her **Elizabeth** on the spot. That is now canon and every file has been updated.
- **Who remembers Elizabeth and Rowan — RESOLVED.** `Old Cobb.md` has been updated to match `Chapter 7 DM Notes.md` (item 4): Elizabeth and Rowan arrived **together, about two months ago**; Elizabeth died of fever shortly after. Both files now agree. (Previously this page said the Cobb file still needed updating — it's been done.)
- **Durgan duplicates Cobb — still live, and now safe to just cut.** `Durgan Half-Ear.md` still carries the "optional connective hook" letting Durgan also be the one who knows Elizabeth and Rowan's fate. Now that `Old Cobb.md` and Ch7 DM Notes agree and Cobb is firmly established as the one who tells JonLief about his family, running Durgan's version too just makes the reveal redundant — recommend cutting the hook from `Durgan Half-Ear.md` rather than leaving it "optional."
